...
#The chatbot, Sora from Kingdom Hearts, greets himself. He is very loud and outgoing
print("Hello! The name's Sora, from Kingdom Hearts!")

#Asks the user how they are doing (do not put any punctuation or it may not pick up some words!)
...
#0: Unknown response (no words both positive or negative were found in the user's response)
...
#3: Mixed response (1+2) (both a positive word and negative word were found in the user's response)
...
favoriteColor = input("There are infinite things to talk about, so I'll just \
    start simple. What's your favorite color?\n").lower()

#Splits the user's response of their favorite color into separate words to be analyzed
splitFavoriteColor = favoriteColor.split(" ")

#Prints "I like that color too! My favourite color is blue :)" when the word
#"purple" or "pink" is in the list of words they inputted
...
#Splits the sentence of the user into words in the variable splitFavouriteFood, which allows each word to be analyzed
...
#Prints "Pasta is quite yummy!" if the word "pasta" is in the list of words in the splitFavoriteFood variable
#Then prints "Just thinking baout food is making me hungry!" after the previous print out
...
#Prints "I should try it sometime... oh wait I can't..." when the word "pasta" is not found in the sentence.
#This automatically prints whether pizza is found as well, to add more variety to the conversation.
else:
    print("I should try it sometime... oh wait I can't...")

#Says goodbye to the user as the final output and program ends
print(f"Well, it was nice to meet you {userName.capitalize()}! I hope we can meet again sometime. \
      I have to go find my friends, Riku and Kairi! See ya later!")